const data=[
    {id:1,title: 'John Wick: Chapitre 4 ', genre:'Action',checked:false,
    ...
    {id:2,title:'La Petite Sirène ' ,genre:'fantastique musical',checked:false,
    ...
    {id:3,title:'Fast and Furious 10' ,genre:'Action',checked:false,
    ...
    {id:4,title: 'Oppenheimer',genre:'Action',checked:false,
    description:'The story of American scientist, J. Robert Oppenheimer, and his role in the development of the atomic bomb.',
    rate:8.5,sortie:2023,imageSrc:'./images/film4.jpg'},

    {id:5,title:'Tyler Rake 2' ,genre:'Action',checked:false,
    ...
    {id:6,title:'Equalizer 3' ,genre:'Action',checked:false,
